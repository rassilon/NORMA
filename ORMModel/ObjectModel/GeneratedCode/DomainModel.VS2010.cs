	...
	public partial class ORMCoreDomainModel : DslModeling::DomainModel
	{
		...
		public sealed override DslModeling::ElementLink CreateElementLink(DslModeling::Partition partition, global::System.Type elementLinkType, DslModeling::RoleAssignment[] roleAssignments, DslModeling::PropertyAssignment[] propertyAssignments)
		{
			...
			if (createElementLinkMap == null)
			{
				...
				createElementLinkMap.Add(typeof(ReadingHasDuplicateSignatureError), 23);
				createElementLinkMap.Add(typeof(ExternalRoleConstraint), 24);
				createElementLinkMap.Add(typeof(ExclusiveOrConstraintCoupler), 25);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasRoleSequence), 26);
				createElementLinkMap.Add(typeof(ConstraintRoleSequenceHasRole), 27);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasTooFewRoleSequencesError), 28);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasTooManyRoleSequencesError), 29);
				createElementLinkMap.Add(typeof(ObjectTypeHasDuplicateNameError), 30);
				createElementLinkMap.Add(typeof(EntityTypeRoleInstanceHasPopulationUniquenessError), 31);
				createElementLinkMap.Add(typeof(FactTypeRoleInstanceHasPopulationUniquenessError), 32);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasExclusionContradictsEqualityError), 33);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasExclusionContradictsSubsetError), 34);
				createElementLinkMap.Add(typeof(ExclusionConstraintHasExclusionContradictsMandatoryError), 35);
				createElementLinkMap.Add(typeof(MandatoryConstraintHasExclusionContradictsMandatoryError), 36);
				createElementLinkMap.Add(typeof(SubsetConstraintHasNotWellModeledSubsetAndMandatoryError), 37);
				createElementLinkMap.Add(typeof(MandatoryConstraintHasNotWellModeledSubsetAndMandatoryError), 38);
				createElementLinkMap.Add(typeof(MandatoryConstraintHasPopulationMandatoryError), 39);
				createElementLinkMap.Add(typeof(ObjectTypeInstanceHasPopulationMandatoryError), 40);
				createElementLinkMap.Add(typeof(ReadingOrderHasReading), 41);
				createElementLinkMap.Add(typeof(FactTypeHasReadingOrder), 42);
				createElementLinkMap.Add(typeof(ReferenceModeHasReferenceModeKind), 43);
				createElementLinkMap.Add(typeof(SetConstraintHasDuplicateNameError), 44);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasDuplicateNameError), 45);
				createElementLinkMap.Add(typeof(EntityTypeHasPreferredIdentifier), 46);
				createElementLinkMap.Add(typeof(ReadingHasTooManyRolesError), 47);
				createElementLinkMap.Add(typeof(ReadingHasTooFewRolesError), 48);
				createElementLinkMap.Add(typeof(ReadingHasReadingRequiresUserModificationError), 49);
				createElementLinkMap.Add(typeof(SetComparisonConstraintHasExternalConstraintRoleSequenceArityMismatchError), 50);
				createElementLinkMap.Add(typeof(ElementAssociatedWithModelError), 51);
			...
			switch (index)
			{
				...
				case 23: return new ReadingHasDuplicateSignatureError(partition, roleAssignments, propertyAssignments);
				case 24: return new ExternalRoleConstraint(partition, roleAssignments, propertyAssignments);
				case 25: return new ExclusiveOrConstraintCoupler(partition, roleAssignments, propertyAssignments);
				case 26: return new SetComparisonConstraintHasRoleSequence(partition, roleAssignments, propertyAssignments);
				case 27: return new ConstraintRoleSequenceHasRole(partition, roleAssignments, propertyAssignments);
				case 28: return new SetComparisonConstraintHasTooFewRoleSequencesError(partition, roleAssignments, propertyAssignments);
				case 29: return new SetComparisonConstraintHasTooManyRoleSequencesError(partition, roleAssignments, propertyAssignments);
				case 30: return new ObjectTypeHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 31: return new EntityTypeRoleInstanceHasPopulationUniquenessError(partition, roleAssignments, propertyAssignments);
				case 32: return new FactTypeRoleInstanceHasPopulationUniquenessError(partition, roleAssignments, propertyAssignments);
				case 33: return new SetComparisonConstraintHasExclusionContradictsEqualityError(partition, roleAssignments, propertyAssignments);
				case 34: return new SetComparisonConstraintHasExclusionContradictsSubsetError(partition, roleAssignments, propertyAssignments);
				case 35: return new ExclusionConstraintHasExclusionContradictsMandatoryError(partition, roleAssignments, propertyAssignments);
				case 36: return new MandatoryConstraintHasExclusionContradictsMandatoryError(partition, roleAssignments, propertyAssignments);
				case 37: return new SubsetConstraintHasNotWellModeledSubsetAndMandatoryError(partition, roleAssignments, propertyAssignments);
				case 38: return new MandatoryConstraintHasNotWellModeledSubsetAndMandatoryError(partition, roleAssignments, propertyAssignments);
				case 39: return new MandatoryConstraintHasPopulationMandatoryError(partition, roleAssignments, propertyAssignments);
				case 40: return new ObjectTypeInstanceHasPopulationMandatoryError(partition, roleAssignments, propertyAssignments);
				case 41: return new ReadingOrderHasReading(partition, roleAssignments, propertyAssignments);
				case 42: return new FactTypeHasReadingOrder(partition, roleAssignments, propertyAssignments);
				case 43: return new ReferenceModeHasReferenceModeKind(partition, roleAssignments, propertyAssignments);
				case 44: return new SetConstraintHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 45: return new SetComparisonConstraintHasDuplicateNameError(partition, roleAssignments, propertyAssignments);
				case 46: return new EntityTypeHasPreferredIdentifier(partition, roleAssignments, propertyAssignments);
				case 47: return new ReadingHasTooManyRolesError(partition, roleAssignments, propertyAssignments);
				case 48: return new ReadingHasTooFewRolesError(partition, roleAssignments, propertyAssignments);
				case 49: return new ReadingHasReadingRequiresUserModificationError(partition, roleAssignments, propertyAssignments);
				case 50: return new SetComparisonConstraintHasExternalConstraintRoleSequenceArityMismatchError(partition, roleAssignments, propertyAssignments);
				case 51: return new ElementAssociatedWithModelError(partition, roleAssignments, propertyAssignments);
